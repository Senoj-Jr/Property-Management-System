    ...
    <div className="h-screen w-screen flex flex-col items-center justify-center bg-[#330000] text-white relative">
      ...
      <div className="z-10 p-10 bg-[#73605B] bg-opacity-95 rounded-3xl shadow-2xl border-4 border-[#D09683] w-[40%] flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col items-center">
          <input type="text" name="tenant_name" value={formData.tenant_name} onChange={handleChange} required placeholder="Name" className="w-3/4 p-3 rounded-lg text-black outline-none shadow-md focus:ring-2 focus:ring-[#D09683] transition" />

          <input type="text" name="mobile_number" value={formData.mobile_number} onChange={handleChange} required placeholder="Phone Number" className="w-3/4 p-3 mt-4 rounded-lg text-black outline-none shadow-md focus:ring-2 focus:ring-[#D09683] transition" />
